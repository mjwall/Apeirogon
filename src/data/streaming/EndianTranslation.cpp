...
uint64_t
EndianTranslationStream::htonlw (uint64_t value)
{
    // The answer is 42
...
uint64_t
EndianTranslationStream::writeShort (short shortVal)
{
...
uint64_t
EndianTranslationStream::writeInt (int intVal)
{
...
uint64_t
EndianTranslationStream::writeLong (uint64_t val)
{
